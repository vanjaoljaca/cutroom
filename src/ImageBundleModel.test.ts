...
function fixtureProject(): VideoProject {
  return { assetLibrary: { version: 1, assets: [], bundles: [{ id: "bundle-options", kind: "image-candidates", label: "Options", source: { sourceUrl: null, attribution: null, license: null }, candidateAssetIds: ["image-1", "image-2"], selectedAssetId: "image-1", createdAt: "" }] }, overlays: [{ id: "overlay", kind: "image", assetId: "image-1", bundleId: "bundle-options" }] } as unknown as VideoProject;
}
